...
public class StatementPrinterTests {
    ...
    void generateHTMLInvoiceTest() {
        ...
        var generatedHTML = InvoiceToHTML.generateHTMLInvoice(invoice.customer, invoice.performances, plays);
    ...
    @Test
        ...
        var result2 = InvoiceToHTML.generateHTMLInvoice(invoice.customer, invoice.performances, plays);
    ...
    @Test
        ...
        Invoice invoice = new Invoice("BigCo", List.of(new Performance("As You Like It", 10)));
        StatementPrinter statementPrinter = new StatementPrinter();
   ...
   @Test
    void statementWithNewPlayTypes() {
        ...
        Assertions.assertThrows(Error.class, () -> {
            InvoiceToHTML.generateHTMLInvoice(invoice.customer, invoice.performances, plays);
        });
    }
}
