...
public class StatementPrinterTests {
    ...
    void generateHTMLInvoiceTest() {
        ...
        var generatedHTML =  InvoiceToHTML.generateHTMLInvoice(invoice.getCustomer(), invoice.performances, plays); // Use the updated method with Invoice object
    ...
    void tragedyWithSmallAudience() {
        ...
        var result2 = InvoiceToHTML.generateHTMLInvoice(invoice.getCustomer(), invoice.performances, plays); // Use the updated method with Invoice object
    ...
    void comedyWithSmallAudience() {
        ...
        var result = statementPrinter.print(invoice, plays);
        var result2 = InvoiceToHTML.generateHTMLInvoice(invoice.getCustomer(), invoice.performances, plays);
    ...
    void statementWithNewPlayTypes() {
        ...
        Assertions.assertThrows(Error.class, () -> {
            InvoiceToHTML.generateHTMLInvoice(invoice.getCustomer(), invoice.performances, plays);
        });
    }
